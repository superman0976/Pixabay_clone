...
const Navbar = () => {
  ...
  return (
    ...
    <div className='container text-center my-3'>
      ...
      <button onClick={()=>fetchImageByCategory("building")} type="button" className="btn btn-outline-danger mx-3">Buildings</button>
      ...
      <button onClick={()=>fetchImageByCategory("music")} type="button" className="btn btn-outline-info mx-3" style={{border:'2px solid red', color:'pink'}}>Music</button>
      <button onClick={()=>fetchImageByCategory("food")} type="button" className="btn btn-outline-light mx-3" style={{border:'2px solid orange',color: 'aqua'}}>Food</button>
    </div>
